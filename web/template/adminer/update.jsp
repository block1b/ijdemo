...
<%--表单--%>
    ...
    <form action="update.action" method="POST" role="form" class="admin-form form-horizontal" enctype="multipart/form-data">

        <input name="role.id" type="hidden" value="<s:property value="#session.update_table.id"/>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input class="form-control" id="role_id" name="role.roleid" type="text" value="<s:property value="#session.update_table.roleid"/>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input class="form-control" id="role_name" name="role.rolename" type="text" value="<s:property value="#session.update_table.rolename"/>">
